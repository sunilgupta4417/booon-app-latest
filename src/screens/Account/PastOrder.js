...
export default PastOrder = () => {
  ...
  const renderStatus = (orderStatusCode, returnQty) => {
        ...
        <View
          ...
          <View style={{paddingLeft: 10, flexGrow: 1, borderWidth: 0}}>
            <Text style={styles.nameTxt} numberOfLines={1}>
              {item?.product_name && item.product_name.length > 20
            ...
            <Text
              ...
              Status: {renderStatus(item?.order_status, item?.return_qty)}{' '}
              {/* <Text
                                style={{
                                    fontWeight: '400',
                                    color: '#64646D99',
            ...
            {item?.is_return == true && item?.order_status === 4 ? (
              <TouchableOpacity
                style={{
        ...
        <View
          ...
          <View
            ...
            {selectedItem?.payment_mode == 0 ? (
              <View>
                ...
                <TextInput
                  ...
                  style={{
                    borderWidth: 1,
                    borderColor: errors.bankAccountName ? 'red' : '#ccc',
                    borderRadius: 5,
                    padding: 8,
                    marginBottom: 5,
                  }}
                ...
                <TextInput
                  ...
                  style={{
                    borderWidth: 1,
                    borderColor: errors.bankAccountNumber ? 'red' : '#ccc',
                    borderRadius: 5,
                    padding: 8,
                    marginBottom: 5,
                  }}
                ...
                <TextInput
                  ...
                  style={{
                    borderWidth: 1,
                    borderColor: errors.bankName ? 'red' : '#ccc',
                    borderRadius: 5,
                    padding: 8,
                    marginBottom: 5,
                  }}
                ...
                <TextInput
                  ...
                  style={{
                    borderWidth: 1,
                    borderColor: errors.bankIFSC ? 'red' : '#ccc',
                    borderRadius: 5,
                    padding: 8,
                    marginBottom: 5,
                  }}
            ...
            <TextInput
              ...
              style={{
                borderWidth: 1,
                borderColor: errors.returnDescription ? 'red' : '#ccc',
                borderRadius: 5,
                padding: 8,
                marginBottom: 5,
                height: 80,
